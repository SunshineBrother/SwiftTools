...
extension UIScrollView {
    ...
    private var emptyText: String? {
        get {
            return  objc_getAssociatedObject(self, HMRuntimeEmptyViewKey.emptyText!) as? String
        }
        set {
            objc_setAssociatedObject(self, HMRuntimeEmptyViewKey.emptyText!, newValue, .OBJC_ASSOCIATION_COPY_NONATOMIC)
        }
    }
    /// 空数据的图片
    private var emptyImage: String? {
        get {
            return  objc_getAssociatedObject(self, HMRuntimeEmptyViewKey.emptyImage!) as? String
        }
        set {
            objc_setAssociatedObject(self, HMRuntimeEmptyViewKey.emptyImage!, newValue, .OBJC_ASSOCIATION_COPY_NONATOMIC)
        }
    }
    ...
    private var offset: CGFloat? {
        get {
            return  objc_getAssociatedObject(self, HMRuntimeEmptyViewKey.offset!) as? CGFloat
        }
        set {
            objc_setAssociatedObject(self, HMRuntimeEmptyViewKey.offset!, newValue, .OBJC_ASSOCIATION_COPY_NONATOMIC)
        }
    ...
    private var newDataBlock: BlockContainer? {
        get {
            return objc_getAssociatedObject(self, HMRuntimeEmptyViewKey.clickClosure!) as? BlockContainer
        }
        set(newValue) {
            objc_setAssociatedObject(self, HMRuntimeEmptyViewKey.clickClosure!, newValue, .OBJC_ASSOCIATION_COPY_NONATOMIC)
        }
    }
